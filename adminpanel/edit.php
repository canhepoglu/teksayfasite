...
if (isset($_GET["id"])) {
  ...
  $siralamaSorgusu = mysqli_query($conn, "SELECT * FROM yoneticiler WHERE id='$id'");
  ...
  if (isset($_POST['submit'])) {
    ...
    $guncelle = mysqli_query($conn, "UPDATE yoneticiler SET kullaniciadi= '$kullaniciadi', sifre= '$sifre', isimsoyisim= '$isimsoyisim', telefonnumarasi= '$telefonnumarasi' WHERE  id = '$id'");
                      ...
                      <div class="card-body">
                        ...
                        <form class="forms-sample" method="post">
                          <div class="form-group">
                            <label for="exampleInputUsername1">Yeni Kullanıcı Adı</label>
                            <input type="text" name="kullaniciadi" value="<?php echo $kayit['kullaniciadi']; ?>" class="form-control" id="exampleInputUsername" placeholder="Username">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Yeni Şifre</label>
                            <input type="password" name="sifre" value="<?php echo $kayit['sifre']; ?>" class="form-control" id="exampleInputPassword1" placeholder="Password">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputUsername1">Yeni İsim Soyisim</label>
                            <input type="text" name="isimsoyisim" value="<?php echo $kayit['isimsoyisim']; ?>" class="form-control" id="exampleInputUsername" placeholder="Username">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputUsername1">Yeni Telefon Numarası</label>
                            <input type="text" name="telefonnumarasi" value="<?php echo $kayit['telefonnumarasi']; ?>" class="form-control" id="exampleInputUsername" placeholder="Username">
                          </div>
                          <button type="submit" name="submit" class="btn btn-primary mr-2">Güncelle</button>
