...
if (isset($_POST['yukle'])) {
  ...
  $filename = $_FILES["kucukresim"]["name"];
  $filename2 = $_FILES["buyukresim"]["name"];
  $folder = "./dosyalar/" . $filename;
  $folder2 = "./dosyalar/" . $filename2;
  $sql = "INSERT INTO `urunler` (`urunadi`, `kucukresim`, `buyukresim`) VALUES ('$urunadi', '$filename', '$filename2')";
