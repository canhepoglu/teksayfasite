...
if (isset($_GET["id"])) {
  ...
  $siralamasorgusu = mysqli_query($conn, "SELECT * from slider where id='$id'");
  ...
  if (isset($_POST['guncelle'])) {
    ...
    $filename = date("YmdHis") . $_FILES["resim"]["name"];
    $folder = "../image/" . $filename;



    if (move_uploaded_file($resim, $folder)) {
      if (file_exists("../dosyalar/" . $kayit["resim"])) {
        unlink("../dosyalar/" . $kayit["resim"]);
      }

      $query = "UPDATE `slider` SET `slideradi` = '$slideradi', `resim` = '$filename', `interval` = $interval WHERE `id` = $id";
        ...
        <div class="content-wrapper">
          <div class="page-header">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="slider.php">Slider Güncelle</a></li>
              </ol>
            </nav>
          </div>
                      ...
                      <div class="card-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <table class="table">
                            ...
                            <tr>
                              <td>Slider Adı</td>
                              <td><input type="text" name="slideradi" class="form-control" /></td>
                            </tr>
                            <tr>
                              <td>Slider Resmi</td>
                            ...
                            <tr>
                              <td>İnterval</td>
                              <td><input type="text" name="interval" class="form-control" /></td>
                            </tr>
                            <tr>
                              <td></td>
                              <td><input class="btn btn-primary" type="submit" name="guncelle" value="Değiştir"></td>
                            </tr>
