              ...
              <div class="card-body">
                ...
                <div class="table-responsive"></br>
                  <table class="table table-bordered ">
                    <thead>
                      <tr>
                        <th class="text-warning col-4"><b> Ürün adı</b> </th>
                        <th class="text-warning col-2"><b> Küçük Resim </b></th>
                        <th class="text-warning col-2"><b> Büyük Resim </b></th>
                        <th class="text-warning col-4"><b> İşlemler </b></th>
                      </tr>
                    </thead>
                    ...
                    while ($b = mysqli_fetch_array($verileriCek)) {
                      ...
                      echo "<tr>
                            ...
                            <td>
                            <a href=\"javascript:sil($id);\" ><i class='mdi mdi-delete-forever' title=Sil>Sil</i></a>
                            <a href='urunguncelle.php?id=$id&action=edit'><i class='mdi mdi-pencil' title=Düzenle>Düzenle</i></a>
                            </td>
                        </tr>";
                    }
