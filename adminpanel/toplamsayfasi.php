...
if (isset($_SESSION["login"]) and $_SESSION["login"]["status"] == 1) {
    ...
    <div class="container-fluid page-body-wrapper">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                ...
                <a class="dropdown-item preview-item" href="sifredegistir.php">
                  ...
                  <div class="preview-item-content">
                    <p class="preview-subject mb-1">Şire Değiştir</p>
                  </div>
                </a>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-4 grid-margin text-center">
              <div class="card">
                <div class="card-body">
                  <h4> YÖNETİCİLER </h4>
                  <div class="row">
                    <div class="col-12 col-sm-12 ">
                      <div class="d-sm-block">
                        <h3 class="text-success ml-2 mb-0 font-weight-medium text-center">
                          <?php
                          $result = mysqli_query($conn, "SELECT COUNT(*) FROM yoneticiler");
                  ...
                  <div class="row">
                    <div class="col-12 col-sm-12 ">
                      <div class="d-sm-block">
                        <h3 class="text-success ml-2 mb-0 font-weight-medium text-center">
                          <?php
                          $result = mysqli_query($conn, "SELECT COUNT(*) FROM urunler");
                          $row = mysqli_fetch_array($result);
                  ...
                  <div class="row">
                    <div class="col-12 col-sm-12 ">
                      <div class="d-sm-block">
                        <h3 class="text-success ml-2 mb-0 font-weight-medium text-center">
                          <?php
                          $result = mysqli_query($conn, "SELECT COUNT(*) FROM slider");
                          $row = mysqli_fetch_array($result);
