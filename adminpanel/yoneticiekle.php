...
if (!empty($_POST)) {
  ...
  $kaydet = mysqli_query($conn, "INSERT INTO yoneticiler (kullaniciadi, sifre, isimsoyisim, telefonnumarasi) 
VALUES ('$kullaniciadi', '$sifre', '$isimsoyisim', '$telefonnumarasi')");
                      ...
                      <div class="card-body">
                        ...
                        <form class="forms-sample" method="post">
                          <div class="form-group">
                            ...
                            <input type="text" name="kullaniciadi" class="form-control" id="exampleInputUsername" placeholder="Username">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="exampleInputUsername1">İsim Soyisim</label>
                            <input type="text" name="isimsoyisim" class="form-control" id="exampleInputUsername" placeholder="Username">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputUsername1">Telefon Numarası</label>
                            <input type="text" name="telefonnumarasi" class="form-control" id="exampleInputUsername" placeholder="Username">
                          </div>
