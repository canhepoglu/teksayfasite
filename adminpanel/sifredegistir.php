...
if (isset($_POST['submit'])) {
    ...
    if ($sifre == $sifre2) {
        $guncelle = mysqli_query($conn, "UPDATE yoneticiler SET sifre= $sifre WHERE  id = $id");
        header("Location:login.php");
        exit;
    } else {
        $error = "Şifreler uyumsuz.";
    }
}
?>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Şifre Değiştirme</a></li>
                            </ol>
                        </nav>
                    </div>
                                    ...
                                    <div class="col-md-6 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form class="forms-sample" onsubmit="return isValid(this)" method="post">
                                                    <?php if (isset($error)) { ?>
                                                        <div class="alert alert-danger hide" id="hata"><?php echo $error; ?></div>
                                                    <?php } ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="sifre2" class="form-control" id="exampleInputPassword2" placeholder="Password">
                                                    </div>
