...
if (isset($_GET["id"])) {
  ...
  $siralamasorgusu = mysqli_query($conn, "SELECT * from urunler where id='$id'");
  $kayit = mysqli_fetch_array($siralamasorgusu);

  if (isset($_POST['guncelle'])) {
    $urunadi = $_POST["urunadi"];
    $kucukresim = $_FILES["kucukresim"]["tmp_name"];
    $buyukresim = $_FILES["buyukresim"]["tmp_name"];
    $filename = date("YmdHis") . $_FILES["kucukresim"]["name"];
    $filename2 = date("YmdHis") . $_FILES["buyukresim"]["name"];
    $folder = "./dosyalar/" . $filename;
    $folder2 = "./dosyalar/" . $filename2;


    if (move_uploaded_file($kucukresim, $folder) && move_uploaded_file($buyukresim, $folder2)) {

      unlink("./dosyalar/" . $kayit["kucukresim"]);
      unlink("./dosyalar/" . $kayit["buyukresim"]);

      $guncelle = mysqli_query($conn, "UPDATE urunler SET urunadi = '$urunadi', kucukresim = '$filename', buyukresim = '$filename2' where id = '$id'");
                      ...
                      <div class="card-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <table class="table">
                            ...
                            <tr>
                              <td>Güncel Ürün Adı</td>
                              <td><input type="text" name="urunadi" class="form-control" /></td>
                            </tr>
                            <tr>
                              <td>Güncel Küçük Resim</td>
                              <td><input type="file" name="kucukresim" class="form-control" /></td>
                            </tr>
                            <tr>
                              <td>Güncel Büyük Resim</td>
                              <td><input type="file" name="buyukresim" class="form-control" /></td>
                            </tr>

                            <tr>
                              <td></td>
                              <td><input class="btn btn-primary" type="submit" name="guncelle" value="Güncelle"></td>
                            </tr>
