...
if (isset($_GET["id"])) {
    ...
    $siralamasorgusu = mysqli_query($conn, "SELECT * from makaleler where id='$id'");
    ...
    if (isset($_POST['guncelle'])) {
        ...
        $filename = date("YmdHis") . $_FILES["makaleresmi"]["name"];
        $folder = "../image/" . $filename;



        if (move_uploaded_file($makaleresmi, $folder)) {
            if (isset($kayit["makaleresmi"]) && file_exists("../dosyalar/" . $kayit["makaleresmi"])) {
                unlink("../dosyalar/" . $kayit["makaleresmi"]);
            }
            try {
                $query = "UPDATE `makaleler` SET `makaleresmi` = '$filename', `makalebaslik` = '$makalebaslik', `makale` = '$makale', `yazar` = '$yazar' WHERE `id` = $id";
                $guncelle = mysqli_query($conn, $query);
            } catch (Exception $e) {
                var_dump($e);
            }
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="makale.php">Makale Güncelle</a></li>
                            </ol>
                        </nav>
                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <td>Makale</td>
                                                            <td><textarea id="mytextarea" type="text" name="makale" class="form-control"></textarea></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Yazar</td>
